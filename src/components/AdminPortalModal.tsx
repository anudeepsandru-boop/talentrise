...
export const AdminPortalModal: React.FC<AdminPortalModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4 bg-slate-950/70 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-5xl bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden my-4 sm:my-8 flex flex-col max-h-[92vh]">
        {/* Modal Top Header */}
        <div className="bg-slate-50 px-6 py-4 border-b border-slate-200 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-purple-50 p-1 border border-purple-200 overflow-hidden flex items-center justify-center shadow-xs">
          ...
          <div className="flex items-center gap-3">
            {isAuthenticated && (
              <button
                ...
                className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-bold text-rose-700 bg-rose-50 hover:bg-rose-100 border border-rose-200 transition-colors"
        ...
        {!isAuthenticated ? (
          ...
          <div className="p-6 sm:p-10 text-center max-w-md mx-auto my-auto space-y-6">
            <div className="w-16 h-16 rounded-2xl bg-purple-50 border border-purple-200 flex items-center justify-center mx-auto text-purple-600 shadow-sm relative">
            ...
            <div className="space-y-1.5">
              <h4 className="text-xl font-extrabold text-slate-950">TalentRise Recruiter Access</h4>
            ...
            <form onSubmit={handleLogin} className="space-y-4 text-left">
              <div>
                <label className="block text-xs font-bold text-slate-700 mb-1.5 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-purple-700 font-mono font-bold">TalentRise Admin</span>
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-10 py-2.5 text-sm text-slate-900 font-mono placeholder-slate-400 focus:outline-none focus:border-purple-500 focus:bg-white"
                  />
                  <button
                    type="button"
              ...
              {errorMsg && (
                <div className="flex items-start gap-2 p-3 rounded-lg bg-rose-50 border border-rose-200 text-xs text-rose-700 font-medium">
              ...
              <button
                type="submit"
                className="w-full py-2.5 rounded-xl text-sm font-bold bg-slate-950 hover:bg-slate-800 text-white shadow-sm transition-all active:scale-95 flex items-center justify-center gap-2"
              >
              ...
              <div className="pt-2 text-center">
                <p className="text-[11px] text-slate-500">
                  Authorized for <strong className="text-slate-800">{FOUNDER_NAME}</strong> & TalentRise Recruiting Team ({DISPLAY_PHONE})
                </p>
              </div>
            </form>
          </div>
          ...
          <div className="flex-1 flex flex-col min-h-0 overflow-hidden bg-[#fafbff]">
            ...
            <div className="px-6 py-3 bg-white border-b border-slate-200 flex flex-wrap items-center justify-between gap-3 shrink-0">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-bold bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 transition-colors shadow-2xs"
                >
