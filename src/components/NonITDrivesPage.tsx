      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        ...
        {nonItJobs.length === 0 ? (
          <div className="text-center py-16 px-4 rounded-2xl bg-white border border-slate-200">
            ...
            <h3 className="text-base font-bold text-slate-900 mb-1">No Non-IT drives match your filters</h3>
            <p className="text-xs text-slate-500 mb-4">Try adjusting your keywords or clearing the search box.</p>
            <button
              onClick={() => {
                setSearchQuery('');
