      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
          <div className="p-5 rounded-2xl bg-slate-900/80 border border-cyan-500/30 shadow-lg">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="text-white font-bold text-sm">Capgemini CATIA V5</h3>
                <span className="text-[11px] text-cyan-400 font-mono font-semibold">Specialized Mechanical & CAD</span>
              </div>
            </div>
          ...
          <div className="p-5 rounded-2xl bg-slate-900/80 border border-blue-500/30 shadow-lg">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-9 h-9 rounded-xl bg-blue-500/15 text-blue-400 flex items-center justify-center">
                <Code2 className="w-5 h-5" />
              </div>
              <div>
                <h3 className="text-white font-bold text-sm">Associate Software Engineers</h3>
                <span className="text-[11px] text-blue-400 font-mono font-semibold">Full-Stack & Cloud Services</span>
              </div>
            </div>
            <p className="text-xs text-slate-400 leading-relaxed">
          ...
          <div className="p-5 rounded-2xl bg-slate-900/80 border border-emerald-500/30 shadow-lg">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="text-white font-bold text-sm">1-on-1 Technical Mock Prep</h3>
                <span className="text-[11px] text-emerald-400 font-mono font-semibold">Founder Mentorship</span>
              </div>
            </div>
            <p className="text-xs text-slate-400 leading-relaxed">
        ...
        <div className="p-4 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-xl mb-8 flex flex-col sm:flex-row items-center gap-3">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full bg-slate-950/80 border border-slate-700/70 rounded-xl pl-10 pr-4 py-2 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400"
            />
            {searchQuery && (
              <button
          ...
          <select
            ...
            className="w-full sm:w-auto bg-slate-950/80 border border-slate-700/70 rounded-xl px-3 py-2 text-xs sm:text-sm text-slate-300 focus:outline-none focus:border-cyan-400"
          >
        ...
        {itJobs.length === 0 ? (
          <div className="text-center py-16 px-4 rounded-2xl bg-slate-900/50 border border-slate-800">
            ...
            <h3 className="text-base font-bold text-white mb-1">No IT drives match your filters</h3>
            <p className="text-xs text-slate-400 mb-4">Try clearing your search query or view all open drives.</p>
            <button
              onClick={() => {
                setSearchQuery('');
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {itJobs.map(job => (
              <div
                key={job.id}
                className="flex flex-col justify-between rounded-2xl bg-slate-900/80 border border-slate-800 hover:border-cyan-500/40 p-5 sm:p-6 shadow-xl hover:shadow-2xl hover:shadow-cyan-950/30 transition-all group"
              >
                <div>
                  <div className="flex items-center justify-between gap-2 mb-3">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="px-2.5 py-0.5 rounded-md text-[11px] font-bold uppercase bg-cyan-500/15 text-cyan-300 border border-cyan-500/30">
                        IT & Tech
                      </span>
                      {job.urgentHiring && (
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 p-3 rounded-xl bg-slate-950/80 border border-slate-800/80 text-xs mb-4">
                    <div>
                      ...
                      <span className="font-bold text-cyan-400">{job.ctc}</span>
                    </div>
                    <div>
                ...
                <div className="pt-4 border-t border-slate-800/80 flex items-center gap-2">
                  <button
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl text-xs sm:text-sm font-bold bg-cyan-600 hover:bg-cyan-500 text-white shadow-md shadow-cyan-950/40 transition-all active:scale-95"
                  >
